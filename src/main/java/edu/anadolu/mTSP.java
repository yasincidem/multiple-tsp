...
public class mTSP {
    ...
    static int swapNodesInRoute;
    static int swapHubWithNodeInRoute;
    static int swapNodesBetweenRoutes;
    static int insertNodeInRoute;
    static int insertNodeBetweenRoutes;
